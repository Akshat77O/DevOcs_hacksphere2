...
const Inventory = () => {
  ...
  const handleAddItem = async () => {
      ...
      try {
          ...
          // If backend returns _id, you may rename it to id
          const itemWithId = {
              ...addedItem,
              id: addedItem._id, // Rename _id to id if needed
          };
          delete itemWithId._id; // Optionally delete _id to avoid sending it

          // Update local state with the new item (including id)
